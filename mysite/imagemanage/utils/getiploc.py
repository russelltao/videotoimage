...
from struct import *
import string
from mysite.settings import QQwryPath
...
class IpLocater :
    ...
    def getIpAddr(self,ip):
        ...
        address = address.decode('gbk', 'ignore')
        address = address.encode('utf8')
        return address
           
 
iplocater = IpLocater(QQwryPath)
 
if __name__ == "__main__" :
    ip_locater = IpLocater( "e:/qqwry.dat" )
    ip = '115.28.146.228'
    address = ip_locater.getIpAddr( 3702883547 )
